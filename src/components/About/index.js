...
function About(props) {
    ...
    return(
        <section className='flex-col-reverse flex justify-center align-middle h-screen max-h-screen scroll-m-20 md:flex-row md:mt-3/12 md:pb-80 md:mx-1/12 md:scroll-m-32 lg:mt-[15%]' id='about-section'>
