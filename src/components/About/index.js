...
function About(props) {
    ...
    return(
        <section className='flex-col-reverse md:flex-row flex justify-center mt-[35%] md:mt-3/12 lg:mt-[15%] md:pb-80 md:mx-1/12 max-h-min scroll-m-20 md:scroll-m-32' id='about-section'>
