...
function Portfolio() {
    ...
    return (
        <section className="static border-t-4 border-white mt-20 max-w-screen-sm p-2">
            ...
            <div className="flex">
                <a href="https://github.com/beimy/photo-port" target={'_blank'}>
                    <img className="max-w-2xl skewed-border-right" 
                        src={require(`../../assets/ohsnap_screenshot.PNG`)}></img>
                </a>
                <div className="">
                    <h3 className="text-4xl font-bold">Oh Snap!</h3>
                    <p className="block skewed-border-left">This was my first project working with the react framework.<br/> 
            ...
            <div className="flex">
                ...
                <a href="https://github.com/beimy/tech-blog" target={'_blank'}>
                    <img className="max-w-2xl skewed-border-left" 
